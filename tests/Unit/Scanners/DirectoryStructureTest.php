...
it('detects a modular approach when a lowercase app-modules directory exists', function () {
    $path = sys_get_temp_dir().'/roster_test_modular_app_modules_'.uniqid();
    $modulesPath = $path.DIRECTORY_SEPARATOR.'app-modules';
